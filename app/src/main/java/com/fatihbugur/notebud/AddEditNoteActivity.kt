package com.fatihbugur.notebud
...
class AddEditNoteActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        addupdateBtn = findViewById(R.id.idButtonUpdate)
        viewModel = ViewModelProvider(this,ViewModelProvider.AndroidViewModelFactory.getInstance(application)
        ).get(NoteViewModel::class.java)

        val noteType = intent.getStringExtra("notType")
      ...
      addupdateBtn.setOnClickListener{
          ...
          if(noteType.equals("Edit")){
              if (noteTitle.isNotEmpty() && noteDescription.isNotEmpty()){
                  ...
                  Toast.makeText(this,"Note Updated Buddy",Toast.LENGTH_LONG).show()
              ...
              if(noteTitle.isNotEmpty() && noteDescription.isNotEmpty()){
                  ...
                  Toast.makeText(this,"Note Added Buddy",Toast.LENGTH_LONG).show()
              }
          }
